package com.teamspirit.our.callrecorder.app;
...
public class MainApplication extends com.github.axet.audiolibrary.app.MainApplication {
    ...
    public void onCreate() {
        ...
        if (!defaultValueSp.getBoolean(PreferenceManager.KEY_HAS_SET_DEFAULT_VALUES, false)) {
            PreferenceManager.setDefaultValues(this, com.teamspirit.our.callrecorder.R.xml.pref_general, false);
    ...
    public int getUserTheme() {
        return getTheme(this, com.teamspirit.our.callrecorder.R.style.RecThemeLight, com.teamspirit.our.callrecorder.R.style.RecThemeDark);
    }
