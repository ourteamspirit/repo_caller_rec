package com.teamspirit.our.callrecorder.activities;
...
public class RecentCallActivity extends AppCompatActivity {
    ...
    int getAppTheme() {
        return MainApplication.getTheme(this, com.teamspirit.our.callrecorder.R.style.AppThemeDialogLight, com.teamspirit.our.callrecorder.R.style.Theme_AppCompat_DayNight_Dialog);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(com.teamspirit.our.callrecorder.R.layout.activity_recentcall, null);

        close = v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_close);
        progressBar = (ProgressBar) v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_progress);
        count = (TextView) v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_autosave);
        msg = v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_msg);
        name = (EditText) v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_name);
        fav = (ImageView) v.findViewById(com.teamspirit.our.callrecorder.R.id.callrecent_fav);
        ...
        alertDialog = new AlertDialog.Builder(this, getAppTheme())
                .setTitle(com.teamspirit.our.callrecorder.R.string.app_name)
                .setIcon(com.teamspirit.our.callrecorder.R.drawable.ic_mic_24dp)
                .setPositiveButton(com.teamspirit.our.callrecorder.R.string.save_button, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        save();
                    }
                })
                .setNeutralButton(com.teamspirit.our.callrecorder.R.string.delete_recording, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                    }
                })
    ...
    void update() {
        ...
        count.setText(getString(com.teamspirit.our.callrecorder.R.string.callrecent_auto_save, AUTO_CLOSE - p));
    ...
    void updateFav() {
        fav.setImageResource(MainApplication.getStar(this, uri) ? com.teamspirit.our.callrecorder.R.drawable.ic_star_black_24dp : com.teamspirit.our.callrecorder.R.drawable.ic_star_border_black_24dp);
    }
