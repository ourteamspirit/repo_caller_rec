package com.teamspirit.our.callrecorder.services;
...
import com.teamspirit.our.callrecorder.activities.MainActivity;
import com.teamspirit.our.callrecorder.activities.RecentCallActivity;
import com.teamspirit.our.callrecorder.activities.SettingsActivity;
import com.teamspirit.our.callrecorder.app.MainApplication;
import com.teamspirit.our.callrecorder.app.Storage;
    ...
    public String getSourceText() {
        switch (source) {
            ...
            case MediaRecorder.AudioSource.VOICE_CALL:
                return getString(com.teamspirit.our.callrecorder.R.string.source_line);
            case MediaRecorder.AudioSource.VOICE_COMMUNICATION:
                return "(VoIP)";
            case MediaRecorder.AudioSource.MIC:
                return getString(com.teamspirit.our.callrecorder.R.string.source_mic);
            case MediaRecorder.AudioSource.DEFAULT:
                return getString(com.teamspirit.our.callrecorder.R.string.source_default);
    ...
    public void showNotificationAlarm(boolean show) {
        ...
        if (!show) {
            ...
            RemoteViews view = new RemoteViews(getPackageName(), MainApplication.getTheme(getBaseContext(),
                    com.teamspirit.our.callrecorder.R.layout.notifictaion_recording_light,
                    com.teamspirit.our.callrecorder.R.layout.notifictaion_recording_dark));

            String title = encoding != null ? getString(com.teamspirit.our.callrecorder.R.string.encoding_title) : (getString(com.teamspirit.our.callrecorder.R.string.recording_title) + " " + getSourceText());
            String text = ".../" + Storage.getDocumentName(targetUri);

            title = title.trim();

            view.setOnClickPendingIntent(com.teamspirit.our.callrecorder.R.id.status_bar_latest_event_content, main);
            view.setTextViewText(com.teamspirit.our.callrecorder.R.id.notification_title, title);
            view.setTextViewText(com.teamspirit.our.callrecorder.R.id.notification_text, text);
            view.setOnClickPendingIntent(com.teamspirit.our.callrecorder.R.id.notification_pause, pe);
            if (recording == null) {
                view.setViewVisibility(com.teamspirit.our.callrecorder.R.id.notification_pause, View.GONE);
            } else {
                view.setViewVisibility(com.teamspirit.our.callrecorder.R.id.notification_pause, View.VISIBLE);
                view.setImageViewResource(com.teamspirit.our.callrecorder.R.id.notification_pause, recording ? com.teamspirit.our.callrecorder.R.drawable.ic_pause_black_24dp : com.teamspirit.our.callrecorder.R.drawable.ic_play_arrow_black_24dp);
            }
            view.setViewVisibility(com.teamspirit.our.callrecorder.R.id.notification_record, View.GONE);
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                    ...
                    .setSmallIcon(com.teamspirit.our.callrecorder.R.drawable.ic_mic_24dp)
                    .setContent(view);
